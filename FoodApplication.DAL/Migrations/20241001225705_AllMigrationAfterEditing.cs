...
{
    /// <inheritdoc />
    public partial class AllMigrationAfterEditing : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteRecipes", x => new { x.FavoriteByUsersId, x.RecipeId });
                    table.ForeignKey(
                        name: "FK_UserFavoriteRecipes_AspNetUsers_FavoriteByUsersId",
